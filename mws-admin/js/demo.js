$(document).ready(function() {
	...
	$('#harga1').attr("disabled","disabled");
	$('#hargab1').attr("disabled","disabled");
		
	/*
	$('#pool_asal').change(function(){
		alert(this.value);
		$('#change_pool_asal_1').val(this.value)
	});
	*/
	...
	$("#add_item").click(function () {
		if(toShow>=30){
		 alert("You only 30 Field!");
		}
		$("#form_"+toShow).show('fast');
		toShow++;
	...
	$('#formb_1').show('slow');
	toShowb=2;
	$("#add_itemb").click(function () {
		if(toShowb>=30){
		 alert("You only 30 Field!");
		}
		$("#formb_"+toShowb).show('fast');
		toShowb++;  
