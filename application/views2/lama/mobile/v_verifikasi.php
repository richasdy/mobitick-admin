...
<div class="container">
    ...
    <h3><i>Verifikasi Tiket</i></h3>

    <form action="verifikasi_proses2" method="post" id="formPemesanan" enctype="multipart/form-data" onSubmit="return validation(this)" >
    ...
    <div class="labelForm">Total Bayar (Rp.)</div>
       ...
       <input name="tanggal" type="text" id="datepicker" readonly class="inputForm" style="width:90px;" required/>
        ...
        <input type="submit" id="submit"  value='VERIFIKASI' class="buttonForm margin" />
        </div>
        </div>
