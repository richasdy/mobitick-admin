...
.mws-button:active, .ui-button.ui-state-active {
	/* CSS 3 */
...
.mws-button:disabled, .ui-button.ui-state-disabled {
	background-color:#e0e0e0;
	color:#aaaaaa;
	cursor:auto;
	text-shadow:none;
...
<body style="background-color:#F90">
<img src="<?=$images?>/bus.png"/><br/>
<p class="center">PO. RAJAWALI</p>
<br/>
<a href="<?=$base_url?>pesantiket2"><input type="button" value="PESAN TIKET" class="mws-button green"/></a>
<br/>
<a href="<?=$base_url?>konfirmasi2"><input type="button" value="KONFIRMASI" class="mws-button green" /></a>
<br/>
<a href="<?=$base_url?>downloadtiket"><input type="button" value="DOWNLOAD TIKET" class="mws-button green" /></a>

<br/>
<a href="<?=$base_url?>maps"><input type="button" value="LOKASI POOL" class="mws-button green" /></a>
<br/>
