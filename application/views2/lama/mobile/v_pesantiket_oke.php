...
<div class="site_wrapper" style="margin-top:30px;">
    ...
    <h3><i>Pemesanan Tiket</i></h3>
		<form action="input_pemesanan_tiket" method="post" id="formPemesanan">
			<fieldset>
				<div class="labelForm">Terima kasih telah melakukan pemesanan.<br/>
              <br/><br/><h2>Kode Verifikasi: <b><?php echo $kode_pemesanan; ?></b></h2></h3><br/>Batas konfirmasi 3 jam setelah pemesanan!</h3></div>
			</fieldset>
