...
<div class="page_title">
	...
	<div class="container">
        ...
        <div class="pagenation">&nbsp;<a href="home">Home</a> <i>/</i> <a href="pesantiket">Pemesanan</a> <i>/</i> Proses Pemesanan</div>
	</div>
</div>
    ...
    <h3><i>Pemesanan Tiket</i></h3>
		<form action="input_pemesanan_tiket" method="post" id="formPemesanan">
			<fieldset>
				<div class="labelForm">Terima kasih telah melakukan pemesanan.
                <br/><br/><h2>Kode Verifikasi: <b><?php echo $kode_pemesanan; ?></h2></b></h3>Segera lakukan konfirmasi!<br/>Batas konfirmasi 3 jam setelah pemesanan!</h3></div>
			</fieldset>
        
        </form> 
    <style>
	 .labelForm{font-size:15px;  width:100%; background:none; text-align:center;}
	 #formPemesanan { background-color:#F7F7F7; padding:20px; border:1px solid #CCC; height:120px;}
	 </style>  
    </div>
    ...
    <div class="container">
     <div class="one_half"> <b>Copyright © 2014 PO. Rajawali. All rights reserved. Terms of Use | Privacy Policy</a></b> </div>
    </div>
	</div>
