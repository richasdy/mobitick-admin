...
<div class="site_wrapper" style="margin-top:30px;">
    ...
    <div class="one_half">
     <h3><i>Form Pemesanan Tiket</i></h3>
		<form action="pesantiket_proses2" method="post" id="formPemesanan" >
			<fieldset>
				<div class="formItem">
					<div class="labelForm">Tanggal Berangkat</div>
						<input name="tanggal" type="text" id="datepicker" readonly class="inputForm" style="width:90px;" onChange="ubah_tanggal()"/>
							<?php
								$length = 6;
