                                    ...
                                    <div class="mws-form-row">
                                        ...
                                        <div class="mws-form-item large">
                                            <div class="mws-form-cols clearfix">
                                                ...
                                                <input type="hidden" name="submitType" value="add"></input>
                                                <input type="hidden" name="trackID" value="-1"></input>
                                            </div>
                                        </div>
							...
							if($pieces[1]!=$t)
								{
									echo '
										<tr>
											...
											<td>
												<input class="mws-button black small" type="button" value="View Rute" onclick="show_detailrute('.$row->ID.')"></input>
												<input class="mws-button green small" type="button" value="Edit"  onclick="edit_track('.$row->ID.')"></input>
												<input class="mws-button red small" type="button" value="Delete"  onclick="confirmDeleteTrack('.$row->ID.')"></input>
											</td>
